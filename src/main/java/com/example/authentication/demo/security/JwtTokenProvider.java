package com.example.authentication.demo.security;
...
import com.example.authentication.demo.service.CustomUserDetailsService;
...
public class JwtTokenProvider {
    ...
    @Value("${security.jwt.token.refresh-token.secret-key}")
    ...
    public Authentication getAuthentication(String token) {
        UserDetails userDetails = UserDetails.loadUserByUsername(getUsername(token));
